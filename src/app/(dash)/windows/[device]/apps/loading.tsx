 ...
 * By App skeleton.
 *   page head 64 / 73 -> 68
 *   Top 10   565 / 565 -> 565 (content 439)
 *
 * Re-measured 2026-08-26 with the sidebar expanded.
 *
 * The table is a deliberate departure. The real card measures ~3,200px,
 ...
 * where nothing is visible to shift. Fourteen rows covers the first viewport at
  ...
  return (
    <>
      ...
      <SkeletonCard contentHeight={0} titleHeight={67}>
        <SkeletonTable rows={14} columns={6} />
      </SkeletonCard>
    </>
  );
}
